...
import com.apirest.books.backend.service.ILibroService;
...
public class LibroRestController {
	...
	public ResponseEntity<LibroResponseRest> consultaPorIdEntity(@PathVariable Long id){
		ResponseEntity<LibroResponseRest> response = service.buscarPorId(id);
		return response;
	}
	
	@PostMapping("/libros")
	public ResponseEntity<LibroResponseRest> crearCategoria(@RequestBody Libro request){
